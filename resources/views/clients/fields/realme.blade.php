<div class="xiaomi-tag">
   <div class="cat-title">
				...
				<h2 class="cat-title-main" id="cat-realme">
					<a href="https://dienthoaihay.vn/realme-pc132.html" title="Realme" id="link-realme">

													<span class="icon_cat_menu">
								
								<img class="lazy after-lazy" alt="Realme" width="257px" height="76px" src="https://dienthoaihay.vn/images/products/cat/resized/realme_1678337740.png" style="display: inline;">							</span>
