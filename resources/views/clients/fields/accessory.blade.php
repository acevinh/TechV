<div class="xiaomi-tag">
    <div class="cat-title">

        <h2 class="cat-title-main" id="cat-phu-kien-do-choi-cong-nghe">
            <a href="https://dienthoaihay.vn/phu-kien-do-choi-cong-nghe-pc164.html" title="Phụ kiện"
                id="link-phu-kien-do-choi-cong-nghe">

                <span class="icon_cat_menu">

                    <img class="lazy after-lazy" alt="Phụ kiện" width="257px" height="76px"
                        src="https://dienthoaihay.vn/images/products/cat/resized/1_1693198028.png"
        ...
        <ul class="nav nav-tabs pull-left">
            <li class="item_tabs" id="item_tab_165165">
                <a title="Xem thêm  Tai nghe" href="https://dienthoaihay.vn/tai-nghe-pc165.html">Tai nghe</a>
            </li>
            <li class="item_tabs" id="item_tab_166166">
                <a title="Xem thêm  Pin dự phòng" href="https://dienthoaihay.vn/pin-du-phong-pc166.html">Pin dự
                    phòng</a>
            </li>
            <li class="item_tabs" id="item_tab_167167">
                <a title="Xem thêm  Đồng hồ thông minh"
                    href="https://dienthoaihay.vn/dong-ho-thong-minh-pc167.html">Đồng hồ thông minh</a>
            </li>
            <li class="item_tabs" id="item_tab_170170">
                <a title="Xem thêm  Sạc cáp" href="https://dienthoaihay.vn/sac-cap-pc170.html">Sạc cáp</a>
            </li>
    ...
    <div class="container">
        ...
        <div class="kobolg-products style-02">
            <div class="response-product product-list-owl owl-slick equal-container better-height"
                data-slick='{"arrows":true,"slidesMargin":30,"dots":false,"infinite":true,"speed":300,"slidesToShow":4,"rows":2}'
                data-responsive='[
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="0">
                                <img class="img-responsive" src="assets/images/apro61-1-270x350.jpg" alt="Black Watches"
                ...
                <div
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="0">
                                <img class="img-responsive" src="assets/images/apro71-1-270x350.jpg" alt="Gaming Mouse"
                ...
                <div
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="0">
                                <img class="img-responsive" src="assets/images/apro101-1-270x350.jpg"
                ...
                <div
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="0">
                                <img class="img-responsive" src="assets/images/apro91-1-270x350.jpg"
                ...
                <div
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="0">
                                <img class="img-responsive" src="assets/images/apro1113-270x350.jpg"
                ...
                <div
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="0">
                                <img class="img-responsive" src="assets/images/apro1211-2-270x350.jpg"
                ...
                <div
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="0">
                                <img class="img-responsive" src="assets/images/apro141-1-270x350.jpg"
                ...
                <div
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="0">
                                <img class="img-responsive" src="assets/images/apro151-1-270x350.jpg"
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="-1">
                                <img class="img-responsive" src="assets/images/apro161-1-270x350.jpg"
                ...
                <div
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#" tabindex="-1">
                                <img class="img-responsive" src="assets/images/apro181-2-270x350.jpg" alt="Red Mouse"
                                    width="270" height="350">
                            </a>
                            <div class="flash">
                                <span class="onnew"><span class="text">New</span></span>
